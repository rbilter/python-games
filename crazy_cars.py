...
class CrazyCars():
    def __init__(self):
        ...
        # game surface
        self.__game_surface = surface.GameSurface(
            self.__SURFACE_WIDTH, self.__SURFACE_HEIGHT)
        self.__game_surface.new_game_surface()

        # game settings
        self.__game_settings = settings.GameSettings()
        self.__game_speed = 5

        # game sound
        self.__game_sound = sound.Sound()
    ...
    def new_game(self):
        self.__P1 = players.Player()
        self.__P1.reset_center(self.__SURFACE_WIDTH)
        self.__E1 = players.Enemy(self.__game_speed)
